	...
	public class TextPattern : BasePattern
	{
		...
		public TextPatternRange DocumentRange
		{
			get
			{
				try
				{
					return TextPatternRange.Wrap(_pattern.DocumentRange, this);
				}
		...
		public TextPatternRange[] GetVisibleRanges()
		{
			try
			{
				return TextPatternRange.Wrap(_pattern.GetVisibleRanges(), this);
			}
			catch (COMException e)
			{
				Exception newEx;
		...
		public TextPatternRange RangeFromChild(AutomationElement childElement)
		{
			...
			try
			{
				return TextPatternRange.Wrap(_pattern.RangeFromChild(childElement.NativeElement), this);
			}
			catch (COMException e)
			{
				Exception newEx;
		...
		public TextPatternRange RangeFromPoint(Point screenLocation)
		{
			try
			{
				return TextPatternRange.Wrap(_pattern.RangeFromPoint(Utility.PointManagedToNative(screenLocation)), this);
			}
			catch (COMException e)
			{
				Exception newEx;
