...
namespace UIAComWrapper
{
	...
	public sealed class AutomationElement
	{
		...
		{
			get { return new AutomationElementInformation(this, true); }
		}
		...
		public AutomationElementCollection CachedChildren
		{
			get
			{
				try
				{
					return AutomationElementCollection.Wrap(NativeElement.GetCachedChildren());
				}
		...
		public AutomationElement CachedParent
		{
			get
			{
				try
				{
					return Wrap(NativeElement.GetCachedParent());
				}
				catch (COMException e)
				{
					Exception newEx;
		...
		public static AutomationElement FocusedElement
		{
			get
			{
				try
				{
					return Wrap(Automation.Factory.GetFocusedElement());
				}
				catch (COMException e)
				{
					Exception newEx;
		...
		public AutomationElement FindFirst(TreeScope scope, Condition condition)
		{
			...
			{
				var elem =
					NativeElement.FindFirstBuildCache(
						(UIAutomationClient.TreeScope) scope,
						condition.NativeCondition,
						CacheRequest.CurrentNativeCacheRequest);
				return Wrap(elem);
		...
		public AutomationPattern[] GetSupportedPatterns()
		{
			...
			var patternIds = (int[]) rawPatternIds;
		...
		public AutomationProperty[] GetSupportedProperties()
		{
			...
			var propertyIds = (int[]) rawPropertyIds;
