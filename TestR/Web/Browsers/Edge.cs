...
namespace TestR.Web.Browsers
{
	...
	public class Edge : Browser
	{
		...
		/// </summary>
		public const string BrowserName = "msedge";

		/// <summary>
		/// The debugging argument for starting the browser.
		/// </summary>
		public const string DebugArgument = "--remote-debugging-port=9223 --profile-directory=\"Default\"";
		...
		public static Browser Create(bool bringToFront = true)
		{
			...
			{
				throw new TestRException("The first instance of Edge was not started with the remote debugger enabled.");
			}
		...
		protected override void BrowserNavigateTo(string uri)
		{
			...
			// todo: There must be a better way to determine when Edge and Firefox is done processing.
			Thread.Sleep(250);
		}
		...
		/// <summary>
		/// Connect to the Edge browser debugger port.
		/// </summary>
		...
		{
			var request = (HttpWebRequest) WebRequest.Create("http://localhost:9223/json");
