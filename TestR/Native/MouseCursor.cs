...
namespace TestR.Native
{
	...
	public class MouseCursor
	{
		...
		static MouseCursor()
		{
			...
			_waitCursors = new List<MouseCursor>();
			_waitCursors.Add(DefaultAndWait);
			_waitCursors.Add(Wait);
			_waitCursors.Add(new MouseCursor(Cursors.WaitCursor.Handle.ToInt32()));
		}
		...
		/// </summary>
		public static IReadOnlyList<MouseCursor> WaitCursors
		{
			get { return _waitCursors.AsReadOnly(); }
		}
